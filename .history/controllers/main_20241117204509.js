...
const layThongTinNhanVien = () => {
    ...
    document.getElementById("tbLuongCB").innerHTML = tbLuongCB;

    let chucvu = document.getElementById('chucvu').value;
    let tbChucVu = validator.validateChucVu(chucvu);  // Gọi phương thức validateChucVu
    document.getElementById("tbChucVu").innerHTML = tbChucVu;
    ...
    document.getElementById("tbGioLam").innerHTML = tbGioLam;
