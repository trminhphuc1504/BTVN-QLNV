...
//Search NV theo loại
document.getElementById('searchName').addEventListener('input',()=>{ //addEventListener de them mot su kien input khi nguoi dung go vao o tim kiem thi doan ma ben duoi se dc thuc thi
    const loai = document.getElementById('searchName').value.trim();// Lấy giá trị từ ô tìm kiếm , trim la de loai bo khoang trang thua o dau va cuoi chuoi
    if(loai){
